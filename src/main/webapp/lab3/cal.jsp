...
<head>
    ...
    <script>
        function submitForm(i){
            ...
            if(!validateForm()){
                ...
                if(i===1)
                    ...
                    document.forms["form"]["action"].value="computeLength";
                form.submit();
            }
        }
        function formReset(){
        ...
        function validateForm(){
            ...
            var val1=document.forms["form"]["firstVal"].value;
            if (parseFloat(val1).toString() === "NaN") {
                alert("First Value is not a Number");
                return false;
            }
            var val2=document.forms["form"]["secondVal"].value;
...
%>
<form method="post" action="<%=request.getContextPath()+"/CalServlet"%>" id="form">
    <table>
        <tr><td>First Val:</td>
        ...
        <tr><td>Second Val:</td>
            ...
            <td>Length:</td>
            <td><input type="text" name="length" value="<%=length%>"></td></tr>
        <tr><td>Result:</td>
            <td><input type="text" name="result" value="<%=result%>"></td></tr>
    </table>
    <p><input type="button" value="add" onclick="submitForm(1)">
        <input type="button" value="subtract" onclick="submitForm(2)">
        <input type="button" value="multiply" onclick="submitForm(3)">
        <input type="button" value="divide" onclick="submitForm(4)">
        <input type="button" value="computeLength" onclick="submitForm(5)">
        <input type="button" value="Reset" onclick="formReset()"></p>
