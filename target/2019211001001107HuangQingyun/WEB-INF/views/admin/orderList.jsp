			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.HuangQingyun.model.Order o=(com.HuangQingyun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.HuangQingyun.dao.UserDao userDao=new com.HuangQingyun.dao.UserDao();
						...
						<%
							...
							String paymentType=com.HuangQingyun.model.Payment.findByPaymentId(con,n);
							 %>
